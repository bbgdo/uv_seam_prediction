...
class UVSEAM_PT_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        post_box.prop(settings, 'postprocess_alpha_cost')
        post_box.prop(settings, 'postprocess_tau_bridge')
        post_box.prop(settings, 'postprocess_conf_floor')
        post_box.prop(settings, 'postprocess_max_low_conf_fraction')
        post_box.prop(settings, 'postprocess_force_close_max_edges')
        post_box.prop(settings, 'postprocess_r_self')
        post_box.prop(settings, 'postprocess_r_cross')
        post_box.prop(settings, 'postprocess_ambiguity_margin')
