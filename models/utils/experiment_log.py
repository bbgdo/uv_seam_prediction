...
class ExperimentLogger:
    ...
    def finalize(self, test_metrics: dict, best_epoch: int, extra_summary: dict | None = None) -> None:
        ...
        self.summary = {
            ...
            'best_val_fpr': best_entry.get('val_fpr', 0) if best_entry else 0,
            'best_val_tpr': best_entry.get('val_tpr', 0) if best_entry else 0,
            'best_val_accuracy': best_entry.get('val_accuracy', 0) if best_entry else 0,
            'test_f1': test_metrics.get('f1', 0),
            'test_precision': test_metrics.get('precision', 0),
            'test_recall': test_metrics.get('recall', 0),
            'test_fpr': test_metrics.get('fpr', 0),
            'test_tpr': test_metrics.get('tpr', 0),
